...
class CSVDataCollector:
    ...
    def setHandCoordData(self, newHandCood: DataFrame) -> None:
        self.__handCoord.append(newHandCood);
    ...
    def getHandCoordData(self) -> List[DataFrame]:
        return self.__handCoord
