...
Export steady coordinates data
"""
...
class Writer:
    ...
    def _concatenate(self, raw_data) -> tuple:
        ...
        orientation: np.ndarray = np.zeros((len(raw_data[2]) + len(raw_data[3])-1, len(raw_data[2][0])))
        if (len(raw_data) ==4):
    ...
    def _writer(self, filename, header: KeysView, data:A, option) -> None:
    ...
    def _updater(self, filename: str, new_data: np.ndarray) -> None:
        with open(filename, "r", newline="") as file:
            ...
            # print(readData)
        header: KeysView = readData[0].keys()
...
if __name__ == "__main__":
    ...
    lista:List = [[['left_pose_X', 'left_pose_Y', 'left_pose_Z'], [-0.210739, 0.070214, 0.198735], [-0.365226, -0.113365, 0.201576]],
                  [['left_orient_1', 'left_orient_2', 'left_orient_3', 'left_orient_4'], [-0.064876, -0.357082, 0.931817, 1.906142], [0.144769, 0.528344, 0.836597, 3.026171]]]
